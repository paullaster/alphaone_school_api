...
class AuthController {
  ...
  <p style="font-family: sans-serif; font-size: 12px; color: #999; margin-top: 20px">
    You can also copy and paste this link into a new browser tab: <a href="${application.weburl}" style="color: #999; text-decoration: none;">${application.weburl}getstarted/confirm</a>
  </p>
